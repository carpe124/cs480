...
\paragraph\indent
As we reviewed the solution devised for this exploration we attempted to think of ways to improve the speed of our calculations. It occured to us that the use of bit shifting might be applied as it is done in the hardware of modern processors. With binary a bit shift will have the following effect: $$n << k = n * 2^{k}$$
